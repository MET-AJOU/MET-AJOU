...
import Box from "@Atoms/Building/test";
...
const FakePlanes = () => {
  ...
  return (
    <>
      ...
      <Box position={[0, 0.38, 0.566]} args={[8.03, 1.2, 4.11]} />
      <Box position={[0.4, 0.6, -3.6]} args={[8.03, 1.7, 4.8]} rotation={[-Math.PI / 1.09, 0, 0]} />
      <Box position={[0.8, 1.23, -7.903]} args={[8.03, 1.7, 4.9]} />
    </>
  );
};
