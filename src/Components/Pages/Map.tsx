...
import AjouMap from "@THREE/Templates/AjouMap";
...
const MapPage = () => {
  ...
  if (window.innerWidth < 768) return <AjouMap setJoinedUserNumber={setJoinedUserNumber} setLoading={setLoading} />;
  return (
    <>
      <AjouMap setJoinedUserNumber={setJoinedUserNumber} setLoading={setLoading} />
